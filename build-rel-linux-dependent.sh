...
"$DOTNET_CLI" publish -r linux-x64 -f net8.0 --no-self-contained -c Release -p:PublishAot=false -p:PublishReadyToRun=true -p:PublishSingleFile=true -o "$SCRIPT_DIR""/release/linux/dependent" "$SCRIPT_DIR""/src/SnowBreakLauncher.csproj" 
